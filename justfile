...
setup-python:
    ...
    # OmniVoice pins transformers>=5.3.0 — installed --no-deps so the pip
    # resolver doesn't deadlock against zipvoice's <4.57.6 pin. The runtime
    # APIs OmniVoice uses (HiggsAudioV2TokenizerModel) require 5.x; the
